...
void cntr_init(void)
{
	...
	((NRF_RTC_Type *) 0x4000B000UL)->EVTENSET = ((0x1UL << (16UL)) |
		(0x1UL << (17UL)));
	((NRF_RTC_Type *) 0x4000B000UL)->INTENSET = ((0x1UL << (16UL)) |
		(0x1UL << (17UL)));
}
u32_t cntr_start(void)
{
	...
	((NRF_RTC_Type *) 0x4000B000UL)->TASKS_START = 1;
	return 0;
}
u32_t cntr_stop(void)
{
	...
	((NRF_RTC_Type *) 0x4000B000UL)->TASKS_STOP = 1;
	return 0;
}
u32_t cntr_cnt_get(void)
{
	return ((NRF_RTC_Type *) 0x4000B000UL)->COUNTER;
}
void cntr_cmp_set(u8_t cmp, u32_t value)
{
	((NRF_RTC_Type *) 0x4000B000UL)->CC[cmp] = value;
}
