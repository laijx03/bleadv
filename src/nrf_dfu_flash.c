...
extern nrf_log_module_dynamic_data_t m_nrf_log_nrf_dfu_flash_logs_data_dynamic;
typedef struct
{
	uint32_t type : 2;
	uint32_t raw : 1;
...
nrf_fstorage_t m_fs __attribute__ ((section("." "fs_data"))) __attribute__((used)) =
{
	...
	.start_addr = (0x0000),
	.end_addr = (0x000FF000UL) + ((1024) * sizeof(uint32_t))
};
...
void dfu_fstorage_evt_handler(nrf_fstorage_evt_t * p_evt)
{
	...
	if (p_evt->result == ((0x0) + 0))
	{
		if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Flash %s success: addr=%p, pending %d"); (void)((p_evt->id == NRF_FSTORAGE_EVT_WRITE_RESULT) ? "write" : "erase"); (void)(p_evt->addr); (void)(m_flash_operations_pending); } }
		;
	}
	else
	{
		if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Flash %s failed (0x%x): addr=%p, len=0x%x bytes, pending %d"); (void)((p_evt->id == NRF_FSTORAGE_EVT_WRITE_RESULT) ? "write" : "erase"); (void)(p_evt->result); (void)(p_evt->addr); (void)(p_evt->len); (void)(m_flash_operations_pending); } }
		;
	}
	if (p_evt->p_param)
	{
		if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("This operation had a callback, calling back to %p."); (void)(p_evt->p_param); } };
		...
		sd_irq_initialized)
{
	...
	if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Calling nrf_dfu_flash_init(sd_irq_initialized=%s)..."); (void)(sd_irq_initialized ? "true" : "false"); } }
	;
	{
		if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Initializing nrf_fstorage_nvmc backend."); } };
		p_api_impl = &nrf_fstorage_nvmc;
	}
	return nrf_fstorage_init(&m_fs, p_api_impl, 
			((void *)0)
			);
}
ret_code_t nrf_dfu_flash_store(uint32_t dest,
		...
		dfu_flash_callback_t callback)
{
	ret_code_t rc;
	m_flash_operations_pending++;
	if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("nrf_fstorage_write(addr=%p, len=0x%x bytes), queue usage: %d"); (void)(dest); (void)(len); (void)(m_flash_operations_pending); } }
	;
	rc = nrf_fstorage_write(&m_fs, dest, p_src, len, (void*)callback);
	if (rc != ((0x0) + 0))
	{
		if (0 && (3 >= 2UL) && (2UL <= 3)) { if (4UL >= 2UL) { (void)(((2UL) | 0 << 16)); (void)("nrf_fstorage_write() failed with error 0x%x."); (void)(rc); } };
	}
	return rc;
}
		...
		dfu_flash_callback_t callback)
{
	ret_code_t rc;
	m_flash_operations_pending++;
	if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("nrf_fstorage_erase(addr=0x%p, len=%d pages), queue usage: %d"); (void)(page_addr); (void)(num_pages); (void)(m_flash_operations_pending); } }
	;
	rc = nrf_fstorage_erase(&m_fs, page_addr, num_pages, (void*)callback);
	if (rc != ((0x0) + 0))
	{
		if (0 && (3 >= 2UL) && (2UL <= 3)) { if (4UL >= 2UL) { (void)(((2UL) | 0 << 16)); (void)("nrf_fstorage_erase() failed with error 0x%x."); (void)(rc); } };
	}
	return rc;
}
