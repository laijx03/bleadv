...
_Bool 
nrf_dfu_settings_peer_data_is_valid(void);
...
_Bool 
nrf_dfu_settings_adv_name_is_valid(void);
...
extern nrf_log_module_dynamic_data_t m_nrf_log_nrf_dfu_settings_logs_data_dynamic;
typedef struct
{
	uint32_t type : 2;
	uint32_t raw : 1;
...
;
uint8_t m_dfu_settings_buffer[((1024) * sizeof(uint32_t))]
__attribute__((section(".bootloader_settings_page")))
__attribute__((used));
uint8_t m_mbr_params_page[((1024) * sizeof(uint32_t))]
...
__attribute__ ((used)) = (0x000FE000UL);
nrf_dfu_settings_t s_dfu_settings;
uint32_t nrf_dfu_settings_crc_get(void)
{
	return crc32_compute((uint8_t*)&s_dfu_settings + 4, 
			__builtin_offsetof (
				nrf_dfu_settings_t
				, 
				init_command
...
void nrf_dfu_settings_init(
		...
		sd_irq_initialized)
{
	if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Running nrf_dfu_settings_init(sd_irq_initialized=%s)."); (void)(sd_irq_initialized ? (uint32_t)"true" : (uint32_t)"false"); } }
	;
	ret_code_t rc = nrf_dfu_flash_init(sd_irq_initialized);
	if (rc != ((0x0) + 0))
	{
		if (0 && (3 >= 1UL) && (1UL <= 3)) { if (4UL >= 1UL) { (void)(((1UL) | 0 << 16)); (void)("nrf_dfu_flash_init() failed with error: %x"); (void)(rc); } };
		do { app_error_handler_bare((rc)); } while (0);
	}
	...
	if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Resetting bootloader settings."); } };
	memset(&s_dfu_settings, 0x00, sizeof(nrf_dfu_settings_t));
	s_dfu_settings.settings_version = 0;
	rc = nrf_dfu_settings_write(
			((void *)0)
			);
	if (rc != ((0x0) + 0))
	{
		if (0 && (3 >= 1UL) && (1UL <= 3)) { if (4UL >= 1UL) { (void)(((1UL) | 0 << 16)); (void)("nrf_dfu_flash_write() failed with error: %x"); (void)(rc); } };
		do { app_error_handler_bare((rc)); } while (0);
	}
}
ret_code_t nrf_dfu_settings_write(dfu_flash_callback_t callback)
{
	ret_code_t err_code;
	if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Writing settings..."); } };
	if (0 && (3 >= 4UL) && (4UL <= 3)) { if (4UL >= 4UL) { (void)(((4UL) | 0 << 16)); (void)("Erasing old settings at: 0x%08x"); (void)((uint32_t)m_dfu_settings_buffer); } };
	err_code = nrf_dfu_flash_erase((uint32_t)m_dfu_settings_buffer, 1, 
			((void *)0)
			);
	if (err_code != ((0x0) + 0))
	{
		if (0 && (3 >= 1UL) && (1UL <= 3)) { if (4UL >= 1UL) { (void)(((1UL) | 0 << 16)); (void)("Could not erase the settings page!"); } };
		return ((0x0) + 3);
	}
	...
	if (err_code != ((0x0) + 0))
	{
		if (0 && (3 >= 1UL) && (1UL <= 3)) { if (4UL >= 1UL) { (void)(((1UL) | 0 << 16)); (void)("Could not write the DFU settings page!"); } };
		return ((0x0) + 3);
	}
	return ((0x0) + 0);
}
__attribute__((weak)) ret_code_t nrf_dfu_settings_additional_erase(void)
{
	if (0 && (3 >= 2UL) && (2UL <= 3)) { if (4UL >= 2UL) { (void)(((2UL) | 0 << 16)); (void)("No additional data erased"); } };
	return ((0x0) + 0);
}
