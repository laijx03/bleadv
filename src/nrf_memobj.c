		...
		read)
{
	...
	if (0) { if (p_head->head_header.data.fields.chunk_cnt >= chunks_expected) { } else { assert_nrf_callback((uint16_t)186, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/experimental_memobj/nrf_memobj.c"); } };
	while (chunk_idx > 0)
	{
