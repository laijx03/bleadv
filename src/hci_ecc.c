...
static _stack_element_t ecc_thread_stack[(384) + 0];
...
static void ecc_thread(void *p1, void *p2, void *p3)
{
	while (
		...
		stack_analyze("ecc stack", K_THREAD_STACK_BUFFER(ecc_thread_stack), sizeof(ecc_thread_stack));
	}
}
...
void bt_hci_ecc_init(void)
{
	...
	k_thread_create(&ecc_thread_data, ecc_thread_stack,
			sizeof(ecc_thread_stack), ecc_thread,
			((void *)0)
			, 
			((void *)0)
			, 
