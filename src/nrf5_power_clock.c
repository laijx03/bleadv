...
static int _m16src_start(struct device *dev, clock_control_subsys_t sub_system)
{
	...
	m16src_grd = 1;
	irq_unlock(imask);
	blocking = ((u32_t) (sub_system));
	if (blocking) {
		u32_t intenset;
		_arch_irq_disable(POWER_CLOCK_IRQn);
		((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_HFCLKSTARTED = 0;
		intenset = ((NRF_CLOCK_Type *) 0x40000000UL)->INTENSET;
		((NRF_CLOCK_Type *) 0x40000000UL)->INTENSET = (0x1UL << (0UL));
		...
		((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_HFCLKSTARTED = 0;
		if (!(intenset & (0x1UL << (0UL)))) {
			((NRF_CLOCK_Type *) 0x40000000UL)->INTENCLR = (0x1UL << (0UL));
		}
		NVIC_ClearPendingIRQ(POWER_CLOCK_IRQn);
		_arch_irq_enable(POWER_CLOCK_IRQn);
	} else {
		((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_HFCLKSTARTED = 0;
		((NRF_CLOCK_Type *) 0x40000000UL)->TASKS_HFCLKSTART = 1;
	}
...
hf_already_started:
	do { } while ((0));
	if (((NRF_CLOCK_Type *) 0x40000000UL)->HFCLKSTAT & (0x1UL << (16UL))) {
		return 0;
	} else {
		return -68;
	}
...
static int _m16src_stop(struct device *dev, clock_control_subsys_t sub_system)
{
	...
	m16src_grd = 1;
	irq_unlock(imask);
	((NRF_CLOCK_Type *) 0x40000000UL)->TASKS_HFCLKSTOP = 1;
	m16src_grd = 0;
	return 0;
}
static int _k32src_start(struct device *dev, clock_control_subsys_t sub_system)
{
	...
	intenset = ((NRF_CLOCK_Type *) 0x40000000UL)->INTENSET;
	((NRF_CLOCK_Type *) 0x40000000UL)->INTENSET = (0x1UL << (1UL));
	lf_clk_src = ((u32_t) (sub_system));
	((NRF_CLOCK_Type *) 0x40000000UL)->LFCLKSRC = lf_clk_src;
	...
	((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_LFCLKSTARTED = 0;
	if (!(intenset & (0x1UL << (1UL)))) {
		((NRF_CLOCK_Type *) 0x40000000UL)->INTENCLR = (0x1UL << (1UL));
	}
	NVIC_ClearPendingIRQ(POWER_CLOCK_IRQn);
	_arch_irq_enable(POWER_CLOCK_IRQn);
	((NRF_CLOCK_Type *) 0x40000000UL)->INTENCLR = (0x1UL << (3UL)) | (0x1UL << (4UL));
	((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_DONE = 0;
	((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_CTTO = 0;
	if ((lf_clk_src & (0x3UL << (0UL))) == (0UL)) {
		int err;
		((NRF_CLOCK_Type *) 0x40000000UL)->CTIV = 16;
		((NRF_CLOCK_Type *) 0x40000000UL)->INTENSET =
			(0x1UL << (3UL)) | (0x1UL << (4UL));
		((NRF_CLOCK_Type *) 0x40000000UL)->INTENSET = (0x1UL << (0UL));
		err = _m16src_start(dev, 
				0
				);
		if (!err) {
...
lf_already_started:
	if (((NRF_CLOCK_Type *) 0x40000000UL)->LFCLKSTAT & (0x1UL << (16UL))) {
		return 0;
	} else {
		return -68;
	}
...
static void _power_clock_isr(void *arg)
{
	...
	krhino_intrpt_enter();
	pof = (((NRF_POWER_Type *) 0x40000000UL)->EVENTS_POFWARN != 0);
	hf_intenset =
		((((NRF_CLOCK_Type *) 0x40000000UL)->INTENSET & (0x1UL << (0UL))) != 0);
	hf_stat = ((((NRF_CLOCK_Type *) 0x40000000UL)->HFCLKSTAT & (0x1UL << (16UL))) != 0);
	hf = (((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_HFCLKSTARTED != 0);
	lf = (((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_LFCLKSTARTED != 0);
	done = (((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_DONE != 0);
	ctto = (((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_CTTO != 0);
	do { } while ((0));
	if (pof) {
		((NRF_POWER_Type *) 0x40000000UL)->EVENTS_POFWARN = 0;
	}
	if (hf) {
		((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_HFCLKSTARTED = 0;
	}
	if (hf_intenset && hf_stat) {
		((NRF_CLOCK_Type *) 0x40000000UL)->INTENCLR = (0x1UL << (0UL));
		((NRF_CLOCK_Type *) 0x40000000UL)->TASKS_CAL = 1;
	}
	if (lf) {
		((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_LFCLKSTARTED = 0;
		do { } while ((0));
	...
	if (done) {
		int err;
		((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_DONE = 0;
		err = _m16src_stop(dev, 
				((void *)0)
				);
		do { } while ((0));
		((NRF_CLOCK_Type *) 0x40000000UL)->TASKS_CTSTART = 1;
	}
	if (ctto) {
		int err;
		((NRF_CLOCK_Type *) 0x40000000UL)->EVENTS_CTTO = 0;
...
{
	({ static struct _isr_list __attribute__((section(".intList"))) __attribute__((__used__)) __isr__power_clock_isr_irq___COUNTER__ = {0, 0, &_power_clock_isr, (void *)0}; os_hwi_set_handler(0, _power_clock_isr, 0); _irq_priority_set(0, 5, 0); 0; })
		;
	_arch_irq_enable(POWER_CLOCK_IRQn);
	return 0;
}
...
static struct device_config __config_clock_nrf5_m16src __attribute__((__used__)) __attribute__((__section__(".devconfig.init"))) = { .name = "nrf5m16srcclockcontrol", .init = (_clock_control_init), .device_pm_control = (device_pm_control_nop), .config_info = (
		((void *)0)
		) }; static struct device __device_clock_nrf5_m16src __attribute__((__used__)) __attribute__((__section__(".init_" "PRE_KERNEL_1" "0"))) = { .config = &__config_clock_nrf5_m16src, .driver_api = &_m16src_clock_control_api, .driver_data = 
	((void *)0) 
}
;
...
static struct device_config __config_clock_nrf5_k32src __attribute__((__used__)) __attribute__((__section__(".devconfig.init"))) = { .name = "nrf5k32srcclockcontrol", .init = (_clock_control_init), .device_pm_control = (device_pm_control_nop), .config_info = (
		((void *)0)
		) }; static struct device __device_clock_nrf5_k32src __attribute__((__used__)) __attribute__((__section__(".init_" "PRE_KERNEL_1" "0"))) = { .config = &__config_clock_nrf5_k32src, .driver_api = &_k32src_clock_control_api, .driver_data = 
	((void *)0) 
}
;
