...
static inline uint8_t nrf_balloc_max_utilization_get(nrf_balloc_t const * p_pool)
{
	if (0) { if (p_pool != 
			((void *)0)
		    ) { } else { assert_nrf_callback((uint16_t)299, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.h"); } };
...
static void * nrf_balloc_idx2block(nrf_balloc_t const * p_pool, uint8_t idx)
{
	if (0) { if (p_pool != 
			((void *)0)
		    ) { } else { assert_nrf_callback((uint16_t)175, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
...
static uint8_t nrf_balloc_block2idx(nrf_balloc_t const * p_pool, void const * p_block)
{
	if (0) { if (p_pool != 
			((void *)0)
		    ) { } else { assert_nrf_callback((uint16_t)188, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
...
ret_code_t nrf_balloc_init(nrf_balloc_t const * p_pool)
{
	...
	if (0) { if (p_pool->p_cb) { } else { assert_nrf_callback((uint16_t)198, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
	if (0) { if (p_pool->p_stack_base) { } else { assert_nrf_callback((uint16_t)199, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
	if (0) { if (p_pool->p_stack_limit) { } else { assert_nrf_callback((uint16_t)200, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
	if (0) { if (p_pool->p_memory_begin) { } else { assert_nrf_callback((uint16_t)201, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
	if (0) { if (p_pool->block_size) { } else { assert_nrf_callback((uint16_t)202, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
...
void * nrf_balloc_alloc(nrf_balloc_t const * p_pool)
{
	if (0) { if (p_pool != 
			((void *)0)
		    ) { } else { assert_nrf_callback((uint16_t)236, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
	void * p_block = 
		((void *)0)
		;
...
void nrf_balloc_free(nrf_balloc_t const * p_pool, void * p_element)
{
	if (0) { if (p_pool != 
			((void *)0)
		    ) { } else { assert_nrf_callback((uint16_t)272, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } };
	if (0) { if (p_element != 
			((void *)0)
		    ) { } else { assert_nrf_callback((uint16_t)273, (uint8_t *)"platform/mcu/nrf52xxx/Drivers/libraries/balloc/nrf_balloc.c"); } }
