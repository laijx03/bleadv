...
static const char *gap_name = "AOS Device";
...
static struct bt_gatt_attr gap_attrs[] = {
	{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2800), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_service, .user_data = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x1800), })), },
	{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2803), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_chrc, .user_data = (&(struct bt_gatt_chrc) { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2a00), })), .properties = 0x02, }),},
	{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2a00), })), .perm = BT_GATT_PERM_READ, .read = read_name, .write = 
		((void *)0)
			, .user_data = 
			((void *)0)
			, }
	,
		{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2803), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_chrc, .user_data = (&(struct bt_gatt_chrc) { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2a01), })), .properties = 0x02, }),},
		{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2a01), })), .perm = BT_GATT_PERM_READ, .read = read_appearance, .write = 
			((void *)0)
				, .user_data = 
				((void *)0)
				, }
...
static struct bt_gatt_service gap_svc = { .attrs = gap_attrs, .attr_count = ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(gap_attrs), __typeof__(&(gap_attrs)[0])))]) - 1) + (sizeof(gap_attrs) / sizeof((gap_attrs)[0])))), };
static struct bt_gatt_ccc_cfg sc_ccc_cfg[(1 + 1)] = {};
...
static struct bt_gatt_attr gatt_attrs[] = {
	{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2800), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_service, .user_data = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x1801), })), },
	{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2803), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_chrc, .user_data = (&(struct bt_gatt_chrc) { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2a05), })), .properties = 0x20, }),},
	{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2a05), })), .perm = BT_GATT_PERM_NONE, .read = 
		((void *)0)
			, .write = 
			((void *)0)
			, .user_data = 
			...
			, }
	,
		{ .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2902), })), .perm = BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, .read = bt_gatt_attr_read_ccc, .write = bt_gatt_attr_write_ccc, .user_data = (&(struct _bt_gatt_ccc) { .cfg = sc_ccc_cfg, .cfg_len = ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(sc_ccc_cfg), __typeof__(&(sc_ccc_cfg)[0])))]) - 1) + (sizeof(sc_ccc_cfg) / sizeof((sc_ccc_cfg)[0])))), .cfg_changed = sc_ccc_cfg_changed, }),},
};
static struct bt_gatt_service gatt_svc = { .attrs = gatt_attrs, .attr_count = ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(gatt_attrs), __typeof__(&(gatt_attrs)[0])))]) - 1) + (sizeof(gatt_attrs) / sizeof((gatt_attrs)[0])))), };
...
submit:
	...
	k_delayed_work_submit(&sc->work, (10));
}
int bt_gatt_service_register(struct bt_gatt_service *svc)
{
	int err;
	...
	do { } while ((0));
	do { } while ((0));
	if (!bt_uuid_cmp(svc->attrs[0].uuid, ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x1800), }))) ||
			!bt_uuid_cmp(svc->attrs[0].uuid, ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x1801), })))) {
		return -69;
	}
		...
		size_t len)
{
	...
	buf = bt_att_create_pdu(conn, 0x1b, sizeof(*nfy) + len);
	if (!buf) {
		;
		return -12;
	}
...
static u8_t notify_cb(const struct bt_gatt_attr *attr, void *user_data)
{
	...
	struct _bt_gatt_ccc *ccc;
	size_t i;
	if (bt_uuid_cmp(attr->uuid, ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2902), })))) {
		if (!bt_uuid_cmp(attr->uuid, ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid.type = BT_UUID_TYPE_16, .val = (0x2803), })))) {
			return BT_GATT_ITER_STOP;
		}
		return BT_GATT_ITER_CONTINUE;
	}
